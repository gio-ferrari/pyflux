...
class Backend(QtCore.QObject):
    ...
    def get_stop_signal(self, stoplive):
        """Para feedback xy (supuestamente discreto).

        Connection: [psf] xyStopSignal (y minflux)
        Description: stops xy tracking
        """
        _lgr.debug("Got stop signal with value %s", stoplive)
        self.toggle_xy_feedback(False)
        # self.toggle_tracking(False)

        # TODO: Restringir a xy
        self.reset_graph()
        self.reset_data_arrays()
